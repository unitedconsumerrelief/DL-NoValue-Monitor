...
def append_row_to_sheet(time_of_call, caller_id, call_type):
    try:
        ...
        # Use append_row which automatically finds the next available row and expands the sheet if needed
        # This is safer than calculating the row number manually, especially when approaching sheet limits
